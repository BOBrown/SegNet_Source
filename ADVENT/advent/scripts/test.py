...
from advent.model.deeplabv3 import get_deeplab_v3_single as get_deeplab_v3

from advent.dataset.Vaihingen import Vaihingen
from advent.dataset.Potsdam import Potsdam
from advent.train_setup.config import cfg, cfg_from_file
from advent.train_setup.eval_single import evaluate_single_model
...
def main(config_file, exp_suffix):
    ...
    # eval
    evaluate_single_model(models, test_loader, cfg)
